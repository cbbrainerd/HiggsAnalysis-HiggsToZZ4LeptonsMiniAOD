...
##process.egmGsfElectronIDs.physicsObjectSrc = cms.InputTag('hTozzTo4leptonsElectronSelector')
...
process.hTozzTo4leptonsSelectionPath = cms.Path(
  ...
  # process. egmGsfElectronIDSequence  * #Reham To add the electron VID HZZWP "merges wit electron pt" 
  process.hTozzTo4leptonsSelectionSequenceData * 
  # process.egmGsfElectronIDSequence  * #Reham To add the electron VID HZZWP 
